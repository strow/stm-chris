...
\begin{block}{}
  \begin{center}
    ...
    \captionof{figure}{AIRS bias relative to SNPP from global statistics. Showing bad channels.}
  \end{center}
\end{block}
...
\begin{block}{}
  \begin{center}
    ...
    \captionof{figure}{AIRS bias relative to SNPP and J1 from SNO.}
  \end{center}
\end{block}
...
\begin{block}{}
  \begin{center}
    ...
    \captionof{figure}{AIRS bias relative to SNPP from SNO and global stats.}
  \end{center}
\end{block}
...
\begin{block}{}
  \begin{center}
    ...
    \captionof{figure}{CrIS bias from JPSS-1 relative to SNPP from SNO and global statistics.}
  \end{center}
\end{block}
...
\begin{frame}{Results 5. Samples of Irradiance variation.}
  ...
  \begin{center}
    ...
    \captionof{figure}{Selected channel variation with irradiance}
  \end{center}
...
\begin{frame}{Results 6. Sample of bias stability.}
  ...
  \begin{center}
    ...
    \captionof{figure}{SW bias variation}
  \end{center}
